...
import com.hotsauce.meem.PhotoEditor.FilterListener;
import com.hotsauce.meem.PhotoEditor.FilterViewAdapter;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    @Override
    public void onToolSelected(com.hotsauce.meem.ToolType toolType) {
        switch (toolType) {
            case BRUSH:
